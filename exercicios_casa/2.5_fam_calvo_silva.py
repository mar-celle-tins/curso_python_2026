...
#%%
letra = input("""
      Olá! Você possui algum sobrenome cuja letra incial é "C" ou "S"?
      (1) Sim
      (2) Não
      """)
...
letra = int(letra)
if letra == 2:
    print("Poxa, você não faz parte das famílias Calvo ou Silva.")
elif letra == 1:
    sobrenome = input("Por favor, digite o seu sobrenome cuja letra inicial é 'C' ou 'S':")
    if sobrenome == "Calvo" or sobrenome == "Silva":
        print("Que legal! Você faz parte das famílias Calvo ou Silva.")
    else:
        print("Poxa, você não faz parte das famílias Calvo ou Silva.")
else:
